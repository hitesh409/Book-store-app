...
//     .catch((e)=>{
//         if(e.status === 500)
//             return {error:false,message:"Item already in the cart"};
//         else 
...
const messages = {
    ...
    UPDATED_FAIL: "Record can not be updated",
    DELETE_SUCCESS: "Record deleted successfully",
    DELETE_FAIL: "Record can not be deleted",
...
const hasAccess = (pathname , user) => {
    const navItem = NavigationItem.find((navItem)=>
...
export default {messages,LocalStorageKeys,NavigationItem,hasAccess}